...
const TaxManager = () => {
  ...
  // Danh sách các dịch vụ thuế hộ kinh doanh
  ...
  const handleDelete = (id) => {
    if (window.confirm('Bạn có chắc chắn muốn xóa dịch vụ này?')) {
      ...
      localStorage.setItem('taxServices', JSON.stringify(updatedServices));
    }
  };
    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-2xl font-bold text-gray-800">Quản Lý Dịch Vụ Thuế Hộ Kinh Doanh</h1>
          <button
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            onChange={handleChange}
            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#D4AF37] text-[#333] bg-white"
            placeholder="Ví dụ: Hộ kinh doanh nhỏ"
          />
        </div>
